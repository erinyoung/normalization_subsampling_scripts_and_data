...
plt.title('Scorpio Support Values by Method and Subsampling Depth', fontsize=16)
plt.xlabel('Subsampling Depth Target', fontsize=12)
plt.ylabel('Scorpio Support', fontsize=12)
plt.grid(True, linestyle='--', alpha=0.6)
plt.savefig('boxplot_scorpio_support.png', dpi=300)
plt.savefig('boxplot_scorpio_support.svg', dpi=300)
plt.close()
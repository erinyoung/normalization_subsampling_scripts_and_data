...
plt.title('Distribution of Mean Depth by Method and Subsampling Depth', fontsize=16)
plt.xlabel('Subsampling Depth Target', fontsize=12)
plt.ylabel('Mean Depth', fontsize=12)
plt.grid(True, linestyle='--', alpha=0.6)
plt.savefig('boxplot_meandepth.png', dpi=300)
plt.savefig('boxplot_meandepth.svg', dpi=300)
plt.close()
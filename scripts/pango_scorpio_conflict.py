...
plt.title('Scorpio Conflict Values by Method and Subsampling Depth', fontsize=16)
plt.xlabel('Subsampling Depth Target', fontsize=12)
plt.ylabel('Scorpio Conflict', fontsize=12)
plt.grid(True, linestyle='--', alpha=0.6)
plt.savefig('boxplot_scorpio_conflict.png', dpi=300)
plt.savefig('boxplot_scorpio_conflict.svg', dpi=300)
plt.close()
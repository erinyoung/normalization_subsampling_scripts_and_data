...
plt.title('Distribution of Mean Map Quality by Method and Subsampling Depth', fontsize=16)
plt.xlabel('Subsampling Depth Target', fontsize=12)
plt.ylabel('Mean Map Quality', fontsize=12)
plt.grid(True, linestyle='--', alpha=0.6)
plt.savefig('boxplot_mapq.png', dpi=300)
plt.savefig('boxplot_mapq.svg', dpi=300)
plt.close()
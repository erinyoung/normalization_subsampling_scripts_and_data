...
print(f"getting together cpu plot for all steps")
...
print(f"getting together memory plot for all steps")
...
print(f"getting together time plot for all steps")
...
plt.savefig(f"time_usage_by_method_and_depth_bar_chart.png", dpi=300)
plt.close()
...
plt.savefig(f"time_usage_by_method_and_depth_bar_chart_logscale.png", dpi=300)
plt.close()